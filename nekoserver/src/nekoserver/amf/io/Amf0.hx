...
class Amf0 {
	...
	public function startWritingResult(output: haxe.io.Output) {
		...
		output.writeInt32(haxe.Int32.ofInt(2));
	}
	
	public function writeEnumPaths(output: haxe.io.Output) {
		output.writeByte(0x0A);
		output.writeInt32(haxe.Int32.ofInt(references.length));
	...
	public function readWithCode(input: haxe.io.Input, id: Int): Dynamic {	
		...
		case 0x07:
			...
			decodedObjects[ind];
		case 0x0A:
			var length = haxe.Int32.toInt(input.readInt32());
		...
		case 0x0B: // date
			...
			cast result;
		case 0x0C:
			cast input.read(haxe.Int32.toInt(input.readInt32()));
		//AMF3 value
		case 0x11:
	...
	public function write(output: haxe.io.Output, v: Dynamic): Bool {
		...
		case TClass(c):
			if (c == cast String) {
				...
				output.writeByte(0x0A);
				output.writeInt32(haxe.Int32.ofInt(copy.length));				
