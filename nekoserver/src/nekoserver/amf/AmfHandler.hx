...
import nekoserver.amf.io.AmfDeserializer;
import nekoserver.amf.io.AmfSerializer;
...
class AmfHandler extends BasicRequestHandler {
	...
	public override function initRequest(): Void {
		...
		var input:BytesInput = new haxe.io.BytesInput(haxe.io.Bytes.ofString(messageBody));
